    ...
    <div className="relative">
      <Select value={value} onValueChange={onChange} disabled={disabled}>
        ...
        <SelectContent className="bg-background border-border shadow-lg z-50">
          ...
          {hoveredConfig && (
            <div className="absolute inset-x-0 bottom-full mb-2 z-[200] pointer-events-none">
              <div className="mx-2 bg-popover text-popover-foreground border border-border rounded-lg p-3 shadow-lg min-w-[220px] max-w-full animate-in fade-in-0 zoom-in-95 duration-150">
